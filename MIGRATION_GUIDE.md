...
```json
{
  ...
  "devDependencies": {
    "@angular-architects/native-federation-v4": "~20.3.6", // Switch over to the (temporary) v4 package
    "@softarc/native-federation": "4.0.0-RC9", // Lock the version to the v4 RC6
